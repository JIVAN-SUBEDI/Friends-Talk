<template>
  ...
  >
    ...
    <!-- Nav items -->
    <ul
      class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 px-4 py-lg-2 px-lg-3 gap-4"
      role="tablist"
    >
      ...
      <li class="nav-item d-none d-xl-block">
        ...
        >
          <div class="avatar avatar-online mx-auto">
            <img class="avatar-img" src="https://st2.depositphotos.com/2944867/8579/i/450/depositphotos_85791042-stock-photo-autumnal-in.jpg" alt="" />
          </div>
        </a>
      </li>
    </ul>
