<template>
  <main class="main is-visible border" data-dropzone-area="">
    <div class="container h-100">
      <div class="d-flex flex-column h-100 position-relative">
                ...
                <div class="col-12 col-xl-6">
                  <div class="row align-items-center gx-5">
                    <div class="col-auto">
                      ...
                      >
                        <img
                          ...
                          width="50px"
                          height="50px"
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYOB6GkyxctiwfJieHOvgp9ohwOV2jUg32jA&s"
                          alt=""
                        />
                      </div>
                    </div>
                    ...
                    <div class="col overflow-hidden">
                      <h6 class="text-truncate">Ollie Chandler</h6>
                      <p class="text-truncate text-small">
                        Typing<span class="typing-dots"
        ...
        <!-- Chat: Content -->
        <div class="chat-body hide-scrollbar flex-1">
              ...
              <div class="message">
                ...
                <div class="message-inner">
                  <div class="message-body">
                    ...
                    <div class="message-content">
                      <div class="message-text">
                        <p class="text-small">Send me the files please.</p>
                      </div>
                    ...
                    <div class="message-content">
                      <div class="message-text">
                        <blockquote class="blockquote overflow-hidden">
                          <h6 class="text-reset text-truncate">
                            William Wright
                          </h6>
                ...
                <div class="message-inner">
                  <div class="message-body">
                    <div class="message-content">
                      <div class="message-text">
                        <p class="text-small">
                          Chandler is typing<span class="typing-dots"
                            ><span>.</span><span>.</span><span>.</span></span
                          >
                        </p>
                      </div>
        ...
        <!-- Chat: Footer -->
        <div
          class="chat-footer pb-4 pb-lg-7 position-absolute bottom-0 start-0 px-4"
        >
          <!-- Chat: Files -->
          <div
          ...
          <!-- Chat: Form -->
          <form class="chat-form rounded-pill bg-light" data-emoji-form="">
            <div class="row d-flex align-items-center gx-0">
              <div class="col-auto d-flex align-items-center">
                <a
                  href="#"
                  class="btn btn-icon btn-link text-body rounded-circle d-flex align-items-center"
                  id="dz-btn"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
              <div class="row align-items-center gx-6">
                <div class="col">
                  <h5>Phone</h5>
                  <p class="text-small">1-800-275-2273</p>
                </div>
            ...
            <li class="list-group-item">
              <div class="row align-items-center gx-6">
                <div class="col">
                  <h5>Location</h5>
                  <p class="text-small">USA, Houston</p>
                </div>
            ...
            <li class="list-group-item">
              <div class="row align-items-center gx-6">
                <div class="col">
                  <h5>E-mail</h5>
                  <p class="text-small">chandler@ollie.com</p>
                </div>
          ...
          <ul class="list-group list-group-flush border-top mt-8">
            <li class="list-group-item">
              <div class="row align-items-center gx-6">
                <div class="col">
                  <h5>Notifications</h5>
                  <p class="text-small">Enable sound notifications</p>
                </div>
